...
Route::post('/lti/add_version', [LtiController::class, 'addVersion']);
...
Route::post('/lti/get_map', [LtiController::class, 'getMap']);
Route::post('/lti/get_versions', [LtiController::class, 'getVersions']);
...
Route::post('/lti/ping', [LtiController::class, 'ping']);
Route::post('/lti/get_conf', [LtiController::class, 'getConfig']);
Route::post('/lti/set_conf', [LtiController::class, 'setConfig']);